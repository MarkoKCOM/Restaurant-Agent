...
The codebase is a Turborepo monorepo: Fastify API + Drizzle ORM + PostgreSQL, React dashboard, Preact booking widget, shared `@sable/domain` types. All deployed via systemd + nginx.
