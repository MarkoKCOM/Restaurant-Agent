...
for (const requiredLoyaltyPackageContent of [
  ...
  "loadLoyaltyGuest",
  "loadLoyaltyClaim",
  "LOYALTY_REFERRAL_SHARE_GUEST_LOOKUP_FAILED",
  "LOYALTY_BALANCE_GUEST_LOOKUP_FAILED",
  "LOYALTY_REWARD_CLAIM_GUEST_LOOKUP_FAILED",
  "LOYALTY_CLAIM_LOOKUP_FAILED",
  "LOYALTY_MESSAGING_PREFERENCES_GUEST_LOOKUP_FAILED",
  "LOYALTY_STAMP_CARD_GUEST_LOOKUP_FAILED",
