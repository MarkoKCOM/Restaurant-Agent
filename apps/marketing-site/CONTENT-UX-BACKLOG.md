...
## 1. Layout / spacing
- [ ] 🟢 Reduce the dead space between the **main hero title and the header** (too much gap at the top).
- [ ] 🟢 Reduce the dead space **between sections** further — the earlier `clamp()` pass (#32) helped but it's still too airy.

## 2. Navbar / header
- [ ] 🟢 Remove the **"Live demo"** nav link (everywhere it appears in the header/nav).
  - Note: decide whether the demo *section* itself stays (see §6) — this is only about the nav link.

## 3. Modules section
- [ ] 🟡 **Bookings → "Concierge".** Reframe so it reads as the restaurant's concierge / customer support:
...
- [ ] 🟡 **Loyalty → "Membership club".** Reframe as the **retention module**:
...
## 4. Pricing
- [ ] 🟢 **Re-label tiers** to: **up to 120 seats**, **up to 200**, **up to 400**, **400+**.
...
- [ ] 🟢 **Starter** includes: **Concierge** (reservations, menu, images, info, customer support), **Owner dashboard**, **Reservation widget**, **Guestbook**.
- [ ] 🟢 **Loyalty** includes: **Retention mechanism**, **Birthday**, **Guestbook gamification**, **"Membership club"**.
...
## 5. Add-ons
- [ ] 🟢 Combine **Inventory + Supplier** into a single **"Full restaurant integration"** super add-on at **₪499/month**.
...
- [ ] 🟢 Replace the **"15 minutes, no fluff"** copy with something **more professional**.
