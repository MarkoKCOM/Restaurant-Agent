...
- gamification health for active challenges, targeted birthday-week challenge creation, stuck challenge completions, referral-code adoption, referral reward-credit mismatches, and streak state problems such as stale streaks, invalid streak preferences, or missing milestone bonuses
