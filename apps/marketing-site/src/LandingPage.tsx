...
const palettes = {
  warm: {
    ...
    launchHover: "#b91c1c",
    popularBadge: "#d97706",
    compHighlight: "rgba(255,251,235,0.5)",
    compHeader: "#fffbeb",
    bullet: "#f59e0b",
    iconBg: "#fef3c7",
    shadow: "rgba(217,119,6,0.2)",
    inputFocus: "#d97706",
    secondaryHover: "rgba(255,251,235,0.8)",
  },
  indigo: {
    accent: "#2E3192",
    accentHover: "#252880",
    accentLight: "#eef2ff",
    accentLighter: "#e0e7ff",
    accentBorder: "#00D1B2",
    accentText: "#2E3192",
    stat: "#00D1B2",
    mint: "#00D1B2",
    ...
    launchHover: "#00b89c",
    popularBadge: "#2E3192",
    compHighlight: "rgba(238,242,255,0.5)",
    compHeader: "#eef2ff",
    bullet: "#00D1B2",
    iconBg: "#e0e7ff",
...
function AccessibilityWidget({ lang, pal }: { lang: Lang; pal: typeof palettes.warm }) {
...
function DemoWidget({ lang, pal }: { lang: Lang; pal: typeof palettes.warm }) {
...
export function LandingPage() {
  ...
  return (
    <div dir={dir} className="min-h-screen bg-white text-gray-900" style={{ direction: dir }}>
      ...
      {/* Accessibility Widget */}
      <AccessibilityWidget lang={lang} pal={pal} />
    </div>
  );
}
